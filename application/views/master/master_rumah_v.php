                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-icon">
                                                    ...
                                                    <input id="id_rumahId" required="required" class="form-control"
                                                   type="text" name="rumahId" readonly/>
                                                </div>
                                                <span class="input-group-btn">
                                                    <a href="#" class="btn btn-success" data-target="#idDivTabelRumah"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <div class="input-icon">
                                                    <i class="fa fa-list fa-fw"></i>
                                                    <input id="id_proyekId" required="required" class="form-control"
                                                   type="text" name="proyekId" readonly/>
                                                </div>
                                                <span class="input-group-btn">
                                                    <a href="#" class="btn btn-success" data-target="#idDivTabelProyek"
                                                    id="id_btnModal" data-toggle="modal">
                                                    <i class="fa fa-search fa-fw"/></i>
                                                    </a>
                                                </span>
                                            ...
                                            <!--
<span id="id_namaProyek"></span>
-->
                                        </div>
                                        <div class="col-md-6">
                                            <label>Nama proyek</label>
                                                    <input id="id_namaProyek" required="required" class="form-control"
                                ...
                                <div class="form-group">
                                    <label>Nama rumah</label>
                                        <div class="input-icon">
                                            <i class="fa fa-list fa-fw"></i>
                                            <input id="id_namaRumah" required="required" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <label>Luas</label>
                                                    ...
                                                    <input id="id_luasRumah" required="required" class="form-control nomor"
                                        ...
                                        <div class="col-md-8">
                                            <label>Harga</label>
                                                ...
                                                <input id="id_hargaRumah" required="required" class="form-control nomor"
