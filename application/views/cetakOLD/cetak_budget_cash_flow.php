...
$this->fpdf->Cell(2 , 0.5, 'Kode' , 0, 'LR', 'L');
$this->fpdf->Cell(6 , 0.5, 'Nama Cash Flow' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Jan' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Feb' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Mar' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Apr' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Mei' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Jun' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Jul' , 0, 'LR', 'L');
$this->fpdf->Cell(2 , 0.5, 'Aug' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Sep' , 0, 'LR', 'L');
$this->fpdf->Cell(1.8 , 0.5, 'Oct' , 0, 'LR', 'L');
$this->fpdf->Cell(2 , 0.5, 'Nov' , 0, 'LR', 'L');
...
$this->fpdf->Cell(5.7, 0.5, $b->nama_cflow , 0, 'LR', 'L');
