...
class Budgetc_cflow extends CI_Controller
{
	...
	function home(){
		$menuId = $this->home_m->get_menu_id('budgetc_cflow/home');
		...
		if(isset($_POST["btnSimpan"])){
			...
			$this->template->load ( 'template/template3', 'budget/budgetc_cflow_v',$data );
		}
	}
